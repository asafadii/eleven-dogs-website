    ...
    <section className="py-20 sm:py-24 lg:py-32 bg-secondary/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 min-w-0">
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight text-foreground leading-tight text-balance">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {trustPoints.map((point) => (
            ...
            >
              ...
              <h3 className="font-heading text-xl font-medium text-foreground mb-3">{point.title}</h3>
